...
void load_policy_file(string json_policy_file, NetPlumber *N, array_t *filter) {
  ...
  for (int i = 0; i < commands.size(); i++) {
    ...
    if (type == "add_source") {
      ...
      // uint32_t i2_table[48] = {10,11,12,20,21,22,30,31,32,40,41,42,50,51,52,60,61,62,70,71,72,80,81,82,90,91,92,100,101,102,110,111,112,120,121,122,130,131,132,140,141,142,150,151,152,160,161,162};
      // uint32_t i2_nrules[48] = {58,869,61,18,843,29,114,202,62,112,174,63,254,118,14,245,125,12,154,166,79,155,145,80,121,123,61,123,108,62,76,103,63,76,90,62,342,204,13,226,142,13,126,247,1644,65,115,365};
