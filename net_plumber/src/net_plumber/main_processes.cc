...
void load_policy_file(string json_policy_file, NetPlumber *N, array_t *filter) {
  ...
  for (int i = 0; i < commands.size(); i++) {
    ...
    if (type == "add_source") {
      ...
      uint32_t i2_table[48] = {58,869,61,18,843,29,114,202,62,112,174,63,254,118,14,245,125,12,154,166,79,155,145,80,121,123,61,123,108,62,76,103,63,76,90,62,342,204,13,226,142,13,126,247,1644,65,115,365};
